...
namespace RpsGame_NoDb
{
    public class RpsGameRepositoryLayer
    {
        ...
        Rps_DbContext DbContext = new Rps_DbContext();
        ...
        //     if (DbContext.matches.Where(x => x.MatchId == match.MatchId) == null)
        //     {
        ...
        public Round PlayRound(Match match, Choice computerChoice, Choice userChoice)
        {
            ...
            {
                DbContext.reounds.Add(round); //  add the round to the Db
                match.Rounds.Add(round); // add the round to the match... NOT to the DB
        ...
        {
            return DbContext.reounds.ToList();
        }
